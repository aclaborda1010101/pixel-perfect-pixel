...
export function buildCanaryP11(): string {
  ...
  s += "DESCRIPCION: URBANA. EDIFICIO SITUADO EN LA CALLE MAYOR NUM 33, COMPUESTO DE DOCE VIVIENDAS Y DOS LOCALES COMERCIALES, CON UNA SUPERFICIE DE 1.240 METROS CUADRADOS. ANEJOS: DOS TRASTEROS Y UN PATIO S. ";
