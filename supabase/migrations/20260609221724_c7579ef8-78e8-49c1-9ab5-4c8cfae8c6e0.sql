...
BEGIN
  ...
  -- n_escaleras: GREATEST(VLM piso01, planta_baja, flag segundas_escaleras)
  ...
  -- Terciario %: vía metadatos HubSpot; fallback: ≥1 local detectado por la IA en PB → mínimo 0.34
