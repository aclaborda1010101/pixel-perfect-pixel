...
REVOKE ALL ON FUNCTION public.correcciones_listado(smallint, text, integer, integer) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.correcciones_listado(smallint, text, integer, integer) FROM anon;
...
REVOKE ALL ON FUNCTION public.archivar_correcciones_obsoletas() FROM PUBLIC;
REVOKE ALL ON FUNCTION public.archivar_correcciones_obsoletas() FROM anon;
